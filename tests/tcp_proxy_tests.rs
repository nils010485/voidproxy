...
#[tokio::test]
async fn test_tcp_proxy_cancellation() {
    let config = Arc::new(Config {
        proxy: ProxyConfig {
            listen_ip: IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)),
            listen_port: 0,
...
#[tokio::test]
async fn test_tcp_proxy_with_ip_filter() {
...
#[tokio::test]
async fn test_tcp_proxy_buffer_pool() {
    let config = Arc::new(Config {
        proxy: ProxyConfig {
            listen_ip: IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)),
            listen_port: 0,
...
#[tokio::test]
async fn test_tcp_proxy_ip_cache() {
    let config = Arc::new(Config {
        proxy: ProxyConfig {
            listen_ip: IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)),
            listen_port: 0,
...
#[tokio::test]
async fn test_tcp_proxy_timeout_values() {
    let config = Arc::new(Config {
        proxy: ProxyConfig {
            listen_ip: IpAddr::V4(Ipv4Addr::new(127, 0, 0, 1)),
            listen_port: 8080,
